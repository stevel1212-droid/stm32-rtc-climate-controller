...
Note: This option is only available after the initial first-time flash.
If you prefer to flash future firmware updates directly via USB (Serial) instead of using the ST-Link debugger,
follow these steps:
